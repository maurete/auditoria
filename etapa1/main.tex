...
En la DIPT la unica relacion que posee con terceros, es con
...  que recurren a ellos cuando se necesitan insumos informáticos.
...
que no se implementan. De esta manera se complica la toma de decisiones
respecto a los equipos a adquirir para proveer el nuevo servicio.

Los usuarios quedan insatisfechos debido a deficiencias en la
funcionalidad de los sistemas. Se pide respuesta de parte del soporte técnico y éste 
se demora. Otra cuestion que causa descontento en los usuarios es que se les
...
%
Falta de roles claros en el lugar
%
Falta de políticas serias
%
Falta de seguridad física: no hay control responsable del acceso
  de personas fisicas
%
Al no haber una adecuada planificación, existe incertidumbre con
  los nuevos servicios
>>>>>>> c248223e7bc84a8c83ec5dc0aa547201cdb2a80b
\end{document}
