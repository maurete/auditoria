...
\section{Hardware}
%
El inventario del hardware del Rectorado es llevado a cabo por la
...
La topología de la red es bastante sencilla, la raíz está junto al
router que conecta a la red externa y a la vez éste conecta a través
de una fibra óptica con el switch al cual estan conectados los
servidores y a los switches principales en los distintos pisos.
