...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% aca quedé --mau
\item[Sistema Ilitia:]
  Es un sistema para la gestión de los servicios a
...
\item[Proyecto ``/oficina'':] Se trata del desarrollo e implementación
  de un proyecto tipo CMS (\eng{Content Management System}) para
...
enlaces de los que hablamos son de \resalt{ver tipo de fibra}fibra
...
tipo de enlace inalámbrico que pudieran llegar a servir de backup.
%
...
colocar algún equipo para mejorar las condiciones de la sala no sería
posible. 

Un problema que presenta esta sala es que una falla en el
...
El sector de informática en con el paso del tiempo a incrementado el
...
%
\subsection*{No existen control de acceso físico}
