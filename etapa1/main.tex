...
y Planificación Tenológica (DIPT), la cual se encarga de llevar a cabo las
...
\item[Actualización de los servidores a la nueva versión estable de
  Debian:]
  Al igual que ocurre con las máquinas de los usuarios,
...
\item [Guía de trámites online para los usuarios:]
  Contempla poner a disposición de los usuarios los formularios
...
amigable y no muy robusto. El más utilizado es el Avira Antivirus Free,
...
raíz. También encontramos el firewall que es simplemente una PC clon
...
capacitación relacionados con la actividad en las que trabajan día a
día.
...
realizan encuentros semanales donde se discuten los temas que hacen
necesaria una capacitación en profundidad de alguno de los
integrantes.
...
Por último, hemos detectado que en la parte de administración existe una
...
enlaces de fibra que permitan soportar eventuales amplicaciones de
...
Como última opción proponemos la posibilidad de mudar la sala de
...
para salvaguardar el existente en caso de alguna falla.
%
\subsection{El espacio de trabajo del personal es reducido}
...
de administración y desarrollo es más numeroso, proponemos reubicar a
...
autenticación a la red de área local mediante un servidor RADIUS .
