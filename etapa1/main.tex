...
enfocadas a algún área en paticular.
...
través de una fibra óptica a los servidores y los switches principales
...
día.
\resalt{completar aca!!!!! con datos concretos}
%
...
a sectores del Rectorado en caso de falla de una interface de red el
los servidores como o una boca de un switch. También genera un riesgo
en caso de corte de los cables de cobre y ópticos, especialmente los enlaces de fibra
más extensos como los que sirven a la secretaría de
Extensión y a la oficina de construcciones.

A partir del traspaso de conexiones de cobre a fibra óptica, quedaron
en desuso los cables de cobre sin embargo están en condiciones de ser reutlizados.
%
...
Un problema que presenta la sala es que una falla en el
acondicionador de aire podría traer problemas serios, especialmente en
verano, dado que no existe un acondicionador de ``back-up'' en caso
...
%special de aquellos que brinda el consorcio SIU.
%
...
un tóner.
\resalt{Agregar detalles de como se maneja con las compras}
